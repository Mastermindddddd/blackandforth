...
const Introduction = () => {
  return (
    <div className="w-full bg-white text-black">
      ...
      <div className="flex flex-col items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 py-16 sm:py-20">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center">
          Introduction
        </h2>
        <div className="w-16 sm:w-24 border-b-4 border-primary my-3"></div>

        <div className="max-w-4xl text-center text-base sm:text-lg md:text-xl leading-relaxed mt-4">
          <p>
